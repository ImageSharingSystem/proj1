...
public class UploadImage extends HttpServlet {
	...
	try {
	     ...
	     */
	    ResultSet rset1 = stmt.executeQuery("SELECT image_sequence.nextval from dual");
	    rset1.next();
	    ...
	    rset.next();
	    BLOB myblob1 = ((OracleResultSet)rset).getBLOB(8);
	    BLOB myblob2 = ((OracleResultSet)rset).getBLOB(9);
