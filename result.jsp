...
<%	
   ...
   s = conn.prepareStatement("select date_upload from tmpT order by date_upload asc");
   try{
   r = s.executeQuery(); }catch(SQLException e){out.println("SQLException: "+e.getMessage());}
   ...
   try{
   rset = stmt.executeQuery(sql);}catch(SQLException e){ out.println("SQLException: "+ e.getMessage());}
   while(rset.next()){
   %></br>
<%
   if(sub.equals("ALL")){
...
<%
   if(usr.equals("ALL")){
   if(sub.equals("ALL")){sql = "select sum(imgNo), owner_name, subject from tmpT where date_upload BETWEEN TO_DATE ('"+fromT+"', 'yyyy-mm-dd') AND TO_DATE ('"+toT+"', 'yyyy-mm-dd') group by owner_name, subject";}
   else if(sub.equals("")){sql = "select sum(imgNo), owner_name from tmpT where date_upload BETWEEN TO_DATE ('"+fromT+"', 'yyyy-mm-dd') AND TO_DATE ('"+toT+"', 'yyyy-mm-dd') group by owner_name";}
   else{ sql = "select sum(imgNo), owner_name from tmpT where date_upload BETWEEN TO_DATE ('"+fromT+"', 'yyyy-mm-dd') AND TO_DATE ('"+toT+"', 'yyyy-mm-dd') AND subject = '"+sub+"' group by owner_name";}
...
<%
   ...
   if(sub.equals("ALL")){sql = "select sum(imgNo), subject from tmpT where date_upload BETWEEN TO_DATE ('"+fromT+"', 'yyyy-mm-dd') AND TO_DATE ('"+toT+"', 'yyyy-mm-dd') group by subject";}
   else if(sub.equals("")){sql = "select sum(imgNo) from tmpT where date_upload BETWEEN TO_DATE ('"+fromT+"', 'yyyy-mm-dd') AND TO_DATE ('"+toT+"', 'yyyy-mm-dd')";}
   else{ sql = "select sum(imgNo) from tmpT where date_upload BETWEEN TO_DATE ('"+fromT+"', 'yyyy-mm-dd') AND TO_DATE ('"+toT+"', 'yyyy-mm-dd') AND subject = '"+sub+"'";}
   //		out.println(sql);
   try{
   rset = stmt.executeQuery(sql);}catch(SQLException e){ out.println("SQLException: " +
   e.getMessage());}
...
<%
   ...
   if(sub.equals("ALL")){sql = "select sum(imgNo), subject from tmpT where date_upload BETWEEN TO_DATE ('"+fromT+"', 'yyyy-mm-dd') AND TO_DATE ('"+toT+"', 'yyyy-mm-dd') AND owner_name = '"+usr+"' group by subject";}
   else if(sub.equals("")){sql = "select sum(imgNo) from tmpT where date_upload BETWEEN TO_DATE ('"+fromT+"', 'yyyy-mm-dd') AND TO_DATE ('"+toT+"', 'yyyy-mm-dd') AND owner_name = '"+usr+"'";}
   else{ sql = "select sum(imgNo) from tmpT where date_upload BETWEEN TO_DATE ('"+fromT+"', 'yyyy-mm-dd') AND TO_DATE ('"+toT+"', 'yyyy-mm-dd') AND owner_name = '"+usr+"' AND subject = '"+sub+"'";}
   //		out.println(sql);
   try{
   rset = stmt.executeQuery(sql);}catch(SQLException e){ out.println("SQLException: " +
   e.getMessage());}
